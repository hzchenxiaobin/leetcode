...
![前缀和与子数组和](images/maxsubarray_prefix_sum.svg)
...
![Kadane 算法状态转移](images/maxsubarray_kadane.svg)
...
![Kadane 算法流程](images/maxsubarray_algorithm_flow.svg)
...
![分治法求最大子数组和](images/maxsubarray_divide_conquer.svg)
