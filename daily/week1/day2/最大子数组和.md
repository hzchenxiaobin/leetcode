...
- [152. 乘积最大子数组](https://leetcode.cn/problems/maximum-product-subarray/)：维护 max/min 两状态的 Kadane
- [53. 最大子数组和](https://leetcode.cn/problems/maximum-subarray/)：Kadane 基础模板
