...
> 💡 这是一道**快慢双指针**的入门题，与 [环形链表（141）](../../week3/day4/环形链表.md) 同源。核心套路：让两个指针从起点出发，慢指针走 1 步、快指针走 2 步，当快指针到达链尾时，慢指针恰好在中间。一次遍历 `O(n)`、`O(1)` 空间，是面试中"链表中点"的标配写法。
...
5. **快慢指针还能解决哪些问题？**
   ...
   - [环形链表（141）](../../week3/day4/环形链表.md)：快慢相遇判环；[环形链表 II（142）](https://leetcode.cn/problems/linked-list-cycle-ii/)：相遇后找入口。
...
- [141. 环形链表](https://leetcode.cn/problems/linked-list-cycle/)（[题解](../../week3/day4/环形链表.md)）：同款快慢双指针，判环改看是否相遇
- [142. 环形链表 II](https://leetcode.cn/problems/linked-list-cycle-ii/)（[题解](../../week9/day4/环形链表 II.md)）：快慢相遇后找环入口，进阶版
- [19. 删除链表的倒数第 N 个结点](https://leetcode.cn/problems/remove-nth-node-from-end-of-list/)（[题解](../../week4/day5/删除链表的倒数第N个节点.md)）：快慢双指针定位倒数位置
- [234. 回文链表](https://leetcode.cn/problems/palindrome-linked-list/)：快慢找中点 + 反转后半段 + 比较
- [148. 排序链表](https://leetcode.cn/problems/sort-list/)（[题解](../../week8/day7/排序链表.md)）：快慢找中点切分 + 归并合并
