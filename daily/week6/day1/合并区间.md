...
> 💡 与 [Day1 Dynamic Batching](../../aiinfra/daily/week6/day1/README.md) 的模式同构：Dynamic Batcher 的 `_collect_batch` 在"时间窗口内收集到达的请求"，类似合并区间中"在重叠范围内合并"。两者都是**排序/有序遍历 + 贪心聚合**的模式。
...
- [56. 合并区间](https://leetcode.cn/problems/merge-intervals/)：区间合并
