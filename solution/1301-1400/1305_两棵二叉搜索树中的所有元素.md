...
- **题目名称**：两棵二叉搜索树中的所有元素
- **链接**：[1305. 两棵二叉搜索树中的所有元素](https://leetcode.cn/problems/all-elements-in-two-binary-search-trees/)
- **难度**：中等
- **标签**：树、二叉搜索树、中序遍历、双指针、归并

## 1. 题目概述

给你两棵**二叉搜索树**的根节点 `root1` 和 `root2`，请你返回一个列表，其中包含**两棵树中的所有整数**并按**升序**排列。
