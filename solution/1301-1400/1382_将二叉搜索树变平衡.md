...
- **题目名称**：将二叉搜索树变平衡
- **链接**：[1382. 将二叉搜索树变平衡](https://leetcode.cn/problems/balance-a-binary-search-tree/)
- **难度**：中等
- **标签**：树、BST、中序遍历、分治、平衡二叉树

## 1. 题目概述

给你一棵二叉搜索树（BST）的根节点 `root`，请返回一棵**平衡**的二叉搜索树。新树应与原树具有**相同的节点值集合**，且满足：每个节点的左右两棵子树的高度差不超过 1。返回任意一种合法的平衡 BST 即可。
