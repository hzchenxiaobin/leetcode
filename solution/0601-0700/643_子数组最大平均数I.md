...
- **题目名称**：子数组最大平均数 I
- **链接**：[643. 子数组最大平均数 I](https://leetcode.cn/problems/maximum-average-subarray-i/)
- **难度**：简单
- **标签**：数组、滑动窗口

## 1. 题目概述

给定一个由 $n$ 个整数组成的数组 `nums` 和一个整数 `k`，找出**长度为 $k$ 的连续子数组**中**平均数最大**的那个，返回该最大平均数。答案误差不超过 $10^{-5}$ 即视为正确。
