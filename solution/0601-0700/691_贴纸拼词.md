...
- **题目名称**：贴纸拼词
- **链接**：[691. 贴纸拼词](https://leetcode.cn/problems/stickers-to-spell-word/)
- **难度**：困难
- **标签**：位运算、动态规划、状态压缩、广度优先搜索

## 1. 题目概述

有 `n` 种不同的贴纸，每个贴纸上有一个小写英文单词。你可以从贴纸上切割单个字母并重新排列，每个贴纸可以**无限次**使用。求拼出给定字符串 `target` 所需的**最少贴纸数量**；若无法拼出则返回 `-1`。
