...
一个网站域名如 `"discuss.leetcode.com"` 包含多个子域名：顶层是 `"com"`，下一层是 `"leetcode.com"`，最底层是 `"discuss.leetcode.com"`。当我们访问 `"discuss.leetcode.com"` 时，也会**隐式访问**它的所有父级域名 `"leetcode.com"` 和 `"com"`。
