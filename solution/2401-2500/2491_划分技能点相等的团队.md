...
- **题目名称**：划分技能点相等的团队
- **链接**：[2491. 划分技能点相等的团队](https://leetcode.cn/problems/divide-players-into-teams-of-equal-skill/)
- **难度**：中等
- **标签**：数组、排序、双指针、贪心

## 1. 题目概述

给定长度为**偶数** $n$ 的正整数数组 `skill`，将其分成 $n/2$ 个 2 人团队，要求每个团队的技能点**之和相等**。团队的「化学反应」= 两名玩家技能点之**乘积**。返回所有团队化学反应之和；若无法等和划分，返回 $-1$。
