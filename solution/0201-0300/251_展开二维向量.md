...
- **题目名称**：展开二维向量
- **链接**：[251. 展开二维向量](https://leetcode.cn/problems/flatten-2d-vector/)
- **难度**：中等
- **标签**：设计、数组、双指针、迭代器

## 1. 题目概述

请为二维向量设计一个迭代器，将其「展平」为一维序列逐元素访问。实现 `Vector2D` 类：
...
- [284. 顶端迭代器](https://leetcode.cn/problems/peeking-iterator/)：在迭代器基础上增加 `peek()` 功能，考察对迭代器状态的保存与恢复
