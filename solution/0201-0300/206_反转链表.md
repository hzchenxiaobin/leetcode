...
## 7. 同类练习题
- [92. 反转链表 II](https://leetcode.cn/problems/reverse-linked-list-ii/)（[题解](../../week11/day4/反转链表 II.md)）：反转指定区间
- [25. K 个一组翻转链表](https://leetcode.cn/problems/reverse-nodes-in-k-group/)（[题解](../../week5/day7/K个一组翻转链表.md)）：分段翻转
- [24. 两两交换链表中的节点](https://leetcode.cn/problems/swap-nodes-in-pairs/)（[题解](../../week11/day3/两两交换链表中的节点.md)）：成对翻转
