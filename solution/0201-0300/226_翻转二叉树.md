...
## 7. 同类练习题
- [101. 对称二叉树](https://leetcode.cn/problems/symmetric-tree/)（[题解](../../week7/day2/对称二叉树.md)）：判定是否镜像对称
- [104. 二叉树的最大深度](https://leetcode.cn/problems/maximum-depth-of-binary-tree/)（[题解](../../week6/day2/二叉树的最大深度.md)）：同样后序递归骨架
- [114. 二叉树展开为链表](https://leetcode.cn/problems/flatten-binary-tree-to-linked-list/)（[题解](../../week9/day5/二叉树展开为链表.md)）：另一种原地修改树结构
