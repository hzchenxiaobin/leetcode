...
- **题目名称**：游戏玩法分析 III
- **链接**：[534. 游戏玩法分析 III](https://leetcode.cn/problems/game-play-analysis-iii/)
- **难度**：中等
- **标签**：SQL、窗口函数、累计求和、SUM OVER、PARTITION BY

## 1. 题目概述

给定 `Activity` 表（结构与 [511. 游戏玩法分析 I](../0501-0600/511_游戏玩法分析I.md)、[512. 游戏玩法分析 II](../0501-0600/512_游戏玩法分析II.md) 完全相同），每行记录一名玩家在某个日期使用某台设备登录并玩过若干局游戏。编写 SQL 查询，报告**每个玩家在每个日期上，截至该日期（含）累计玩过的总游戏局数**。
