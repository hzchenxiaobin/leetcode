...
- **题目名称**：好友申请 I：总体通过率
- **链接**：[597. Friend Requests I: Overall Acceptance Rate](https://leetcode.cn/problems/friend-requests-i-overall-acceptance-rate/)
- **难度**：简单
...
给定 `FriendRequest`（好友申请发送记录）与 `RequestAccepted`（好友申请通过记录）两张表，编写 SQL 查询，求**总体通过率**：
