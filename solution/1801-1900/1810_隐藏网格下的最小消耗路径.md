...
- **题目名称**：隐藏网格下的最小消耗路径
- **链接**：[1810. 隐藏网格下的最小消耗路径](https://leetcode.cn/problems/minimum-path-cost-in-a-hidden-grid/)
- **难度**：中等
- **标签**：深度优先搜索、最短路、堆（优先队列）、交互

## 1. 题目概述

这是一道**交互题**，也是 [1778. 未知网格中的最短路径](../1701-1800/1778_未知网格中的最短路径.md) 的**加权升级版**。在一个未知的网格中，机器人从 $(0, 0)$ 出发，目标是到达网格中的**目标格**，且要求路径**总消耗最小**。
