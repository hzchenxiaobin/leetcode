...
> 💡 与 [Day6 Benchmark](../../../ai-infra-notes/aiinfra/daily/week6/day6/README.md) 扫描并发数找饱和点同构——benchmark 扫 concurrency=1,2,4,...,64 找"throughput 增长率开始下降"的拐点，正如股票在价格序列中找"最低买入+最高卖出"的最大差值。两者都是一次遍历维护极值。
