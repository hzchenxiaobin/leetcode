...
- **题目名称**：圆圈中最后剩下的数字
- **链接**：[剑指 Offer 62. 圆圈中最后剩下的数字](https://leetcode.cn/problems/yuan-quan-zhong-zui-hou-sheng-xia-de-shu-zi-lcof/)
- **难度**：简单
- **标签**：数学、递推、动态规划

## 1. 题目概述

`0,1,···,n-1` 这 `n` 个数字排成一个圆圈，从数字 `0` 开始，每次从这个圆圈里删除第 `m` 个数字（删除后从下一个数字开始继续数）。求这个圆圈里剩下的最后一个数字。
