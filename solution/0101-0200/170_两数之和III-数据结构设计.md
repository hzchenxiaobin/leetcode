...
- **题目名称**：两数之和 III - 数据结构设计
- **链接**：[170. 两数之和 III - 数据结构设计](https://leetcode.cn/problems/two-sum-iii-data-structure-design/)
- **难度**：简单
- **标签**：设计、哈希表

## 1. 题目概述

设计一个数据结构，接受一个整数流，并支持以下两种操作：
...
- [454. 四数相加 II](https://leetcode.cn/problems/4sum-ii/)（[题解](../0001-0100/454_四数相加II.md)）：四个独立数组分组 + 哈希，Meet in the Middle 思想
