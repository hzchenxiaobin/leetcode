...
> 💡 与 [Day3 vLLM Scheduler](../../../ai-infra-notes/aiinfra/daily/week6/day3/README.md) 的 `BlockSpaceManager` 同构：vLLM 用 `free_blocks` 空闲链表回收/分配 KV Cache block，preemption 时被抢占序列的 block 被淘汰回空闲池供他人复用——正是 LRU 式的"有限资源池分配/回收/淘汰"。
