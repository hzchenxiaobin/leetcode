...
## 7. 同类练习题
- [100. 相同的树](https://leetcode.cn/problems/same-tree/)（[题解](../../week12/day2/相同的树.md)）：同侧配对，结构相同
- [226. 翻转二叉树](https://leetcode.cn/problems/invert-binary-tree/)（[题解](../../week4/day4/翻转二叉树.md)）：翻转后与原树相等即对称
