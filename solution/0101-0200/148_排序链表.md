...
## 7. 同类练习题
- [148. 排序链表](https://leetcode.cn/problems/sort-list/)（[题解](排序链表.md)）：归并排序链表
- [21. 合并两个有序链表](https://leetcode.cn/problems/merge-two-sorted-lists/)（[题解](../../week2/day4/合并两个有序链表.md)）：归并合并
- [23. 合并 K 个升序链表](https://leetcode.cn/problems/merge-k-sorted-lists/)（[题解](../../week7/day5/合并K个升序链表.md)）：堆/分治合并
