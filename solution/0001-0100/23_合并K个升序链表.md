...
> 💡 与 [Week7 Day5 系统联调](../../../ai-infra-notes/aiinfra/daily/week7/day5/README.md) 中的 **Scheduler 优先级调度**同构——Scheduler 用 `heapq` 从 waiting 队列按优先级弹出请求，合并链表用最小堆从 K 个链表弹最小节点。两者都是"多路归并用堆维护全局最优"的核心模式。
