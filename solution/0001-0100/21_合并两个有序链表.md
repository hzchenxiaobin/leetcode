...
## 7. 同类练习题
- [23. 合并 K 个升序链表](https://leetcode.cn/problems/merge-k-sorted-lists/)（[题解](../../week7/day5/合并K个升序链表.md)）：分治/堆合并
- [148. 排序链表](https://leetcode.cn/problems/sort-list/)（[题解](../../week8/day7/排序链表.md)）：归并排序链表
- [21. 合并两个有序链表](https://leetcode.cn/problems/merge-two-sorted-lists/)（[题解](合并两个有序链表.md)）：哑节点 + 双指针
