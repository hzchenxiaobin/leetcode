...
- [152. 乘积最大子数组](https://leetcode.cn/problems/maximum-product-subarray/)（[题解](../../week4/day1/乘积最大子数组.md)）：维护 max/min 两状态的 Kadane
- [53. 最大子数组和](https://leetcode.cn/problems/maximum-subarray/)（[题解](最大子数组和.md)）：Kadane 基础模板
