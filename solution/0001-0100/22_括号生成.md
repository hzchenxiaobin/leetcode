...
- [20. 有效的括号](https://leetcode.cn/problems/valid-parentheses/)（[题解](../day3/有效括号.md)）：判定给定串是否合法（栈），与本题的生成对偶
- [32. 最长有效括号](https://leetcode.cn/problems/longest-valid-parentheses/)（[题解](../../week8/day5/最长有效括号.md)）：求最长合法子串（栈/DP），同一合法性的最优化版本
