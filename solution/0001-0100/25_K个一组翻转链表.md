...
> 💡 与 [Day7 推理系统 Chunked Prefill](../../../ai-infra-notes/aiinfra/daily/week5/day7/README.md) 的模式同构：都是"把大块连续处理拆成固定大小分段处理，尾段特殊处理"。翻转链表的"不足 k 保持原序" = Chunked Prefill 的"最后一块可能不满"。
