...
- **题目名称**：两天自由外汇交易后的最大货币数
- **链接**：[3387. 两天自由外汇交易后的最大货币数](https://leetcode.cn/problems/maximize-amount-after-two-days-of-conversions/)
- **难度**：中等
...
给你一个字符串 `initialCurrency` 表示初始货币，你一开始拥有 $1.0$ 单位的它。另给两组数据：
