...
- **题目名称**：从一个范围内选择最多整数 I
- **链接**：[2554. 从一个范围内选择最多整数 I](https://leetcode.cn/problems/maximum-number-of-integers-to-choose-from-a-range-i/)
- **难度**：中等
- **标签**：贪心、数组、哈希表

## 1. 题目概述

给定一个整数数组 `banned` 和两个整数 `n`、`maxSum`。从范围 $[1, n]$ 中选择一些整数，需满足：
