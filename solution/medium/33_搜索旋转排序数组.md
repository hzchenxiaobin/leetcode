...
- [34. 在排序数组中查找元素的第一个和最后一个位置](https://leetcode.cn/problems/find-first-and-last-position-of-element-in-sorted-array/)（[题解](../medium/34_在排序数组中查找元素的第一个和最后一个位置.md)）：普通有序数组的二分边界，对比「无旋转」时的简单情形
