...
## 7. 同类练习题
- [230. 二叉搜索树中第 K 小的元素](https://leetcode.cn/problems/kth-smallest-element-in-a-bst/)（[题解](../../week13/day6/二叉搜索树中第K小的元素.md)）：中序遍历
- [98. 验证二叉搜索树](https://leetcode.cn/problems/validate-binary-search-tree/)（[题解](验证二叉搜索树.md)）：中序单调性
- [108. 将有序数组转换为二叉搜索树](https://leetcode.cn/problems/convert-sorted-array-to-binary-search-tree/)（[题解](../../week13/day1/将有序数组转换为二叉搜索树.md)）：分治构造
