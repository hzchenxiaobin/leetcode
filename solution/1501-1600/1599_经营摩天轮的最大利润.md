...
- **题目名称**：经营摩天轮的最大利润
- **链接**：[1599. 经营摩天轮的最大利润](https://leetcode.cn/problems/maximum-profit-of-operating-a-centennial-wheel/)
- **难度**：中等
- **标签**：数组、贪心、模拟

## 1. 题目概述

你经营一座摩天轮，共有 **4 个座舱**，每个座舱**最多容纳 4 位游客**。每次逆时针轮转需支付运行成本 `runningCost`。游客在登上离地面最近的座舱时支付 `boardingCost`，该座舱再次抵达地面时离开。
