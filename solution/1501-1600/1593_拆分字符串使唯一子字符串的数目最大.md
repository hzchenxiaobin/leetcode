...
- **题目名称**：拆分字符串使唯一子字符串的数目最大
- **链接**：[1593. 拆分字符串使唯一子字符串的数目最大](https://leetcode.cn/problems/split-a-string-into-the-max-number-of-unique-substrings/)
- **难度**：中等
- **标签**：字符串、回溯、哈希表

## 1. 题目概述

给定字符串 `s`，将其拆分为若干**非空子字符串**，使得：
