...
- **题目名称**：服务中心的最佳位置
- **链接**：[1515. 服务中心的最佳位置](https://leetcode.cn/problems/best-position-for-a-service-centre/)
- **难度**：困难
- **标签**：几何、三分搜索、凸优化、数值方法

## 1. 题目概述

给定平面上 `n` 个客户的位置 `positions[i] = [xi, yi]`，求一个服务中心坐标 `[xcentre, ycentre]`，使该中心**到所有客户的欧几里得距离之和最小**：
