...
- **题目名称**：合作过至少三次的演员和导演
- **链接**：[1050. Actors and Directors Who Cooperate At Least Three Times](https://leetcode.com/problems/actors-and-directors-who-cooperate-at-least-three-times/)
- **难度**：简单
...
给定表 `ActorDirector`，记录演员与导演的每次合作。请编写 SQL 查询，找出**合作过至少三次**的所有 `(actor_id, director_id)` 对。
