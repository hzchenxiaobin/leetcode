...
- **题目名称**：乘坐火车路线的最少费用
- **链接**：[2361. 乘坐火车路线的最少费用](https://leetcode.cn/problems/minimum-costs-using-the-train-line/)
- **难度**：困难
- **标签**：数组、动态规划

## 1. 题目概述

城市中的火车有两条路线：**常规路线**和**特快路线**。两条路线经过**相同**的 $n+1$ 个车站，编号 $0$ 到 $n$。初始时你位于车站 $0$ 的常规路线上。
