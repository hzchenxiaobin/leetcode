...
- **题目名称**：相邻字符串之间的最长公共前缀
- **链接**：[3598. 相邻字符串之间的最长公共前缀](https://leetcode.cn/problems/longest-common-prefix-between-adjacent-strings-after-removals/)
- **难度**：中等
- **标签**：数组、字符串、前缀和

## 1. 题目概述

给你一个字符串数组 `words`，对范围 $[0, n-1]$ 内的**每个下标** $i$ 独立执行：
