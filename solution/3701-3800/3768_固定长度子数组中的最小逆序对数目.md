...
- **题目名称**：固定长度子数组中的最小逆序对数目
- **链接**：[3768. 固定长度子数组中的最小逆序对数目](https://leetcode.cn/problems/minimum-inversion-count-in-subarrays-of-fixed-length/)
- **难度**：困难
- **标签**：树状数组、线段树、数组、滑动窗口

## 1. 题目概述

给你一个长度为 $n$ 的整数数组 $\text{nums}$ 和一个整数 $k$。
