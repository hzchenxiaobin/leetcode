...
- **题目名称**：阶乘生成器
- **链接**：[2803. 阶乘生成器](https://leetcode.cn/problems/factorial-generator/)
- **难度**：简单
- **标签**：数学、生成器
...
编写一个**生成器函数**（generator function） `factorialGenerator(n)`，给定一个非负整数 `n`，依次产出（yield）阶乘序列 $0!,\; 1!,\; 2!,\; \dots,\; n!$。
