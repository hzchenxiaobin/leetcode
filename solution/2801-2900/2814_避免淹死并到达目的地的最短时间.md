...
- **题目名称**：避免淹死并到达目的地的最短时间
- **链接**：[2814. 避免淹死并到达目的地的最短时间](https://leetcode.cn/problems/minimum-time-takes-to-reach-destination-without-drowning/)
- **难度**：困难
- **标签**：广度优先搜索、数组、矩阵
