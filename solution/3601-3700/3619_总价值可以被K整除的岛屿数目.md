...
- **题目名称**：总价值可以被K整除的岛屿数目
- **链接**：[3619. 总价值可以被 K 整除的岛屿数目](https://leetcode.cn/problems/count-islands-with-total-value-divisible-by-k/)
- **难度**：中等
- **标签**：深度优先搜索、广度优先搜索、并查集、数组、矩阵

## 1. 题目概述

给你一个 $m \times n$ 的矩阵 `grid` 和一个正整数 $k$。**岛屿**是由**正**整数（表示陆地）组成的、格子间**四周**连通（水平或垂直）的区域；值为 $0$ 的格子是水。
