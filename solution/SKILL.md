...
| 优先级 | 题号 | 题目 | 难度 | 高频理由 |
|--------|------|------|------|----------|
| 1 | 93 | 复原 IP 地址 | 中等 | 回溯经典，分段剪枝 |
| 2 | 8 | 字符串转换整数（atoi） | 中等 | 边界处理考察，高频 |
| 3 | 14 | 最长公共前缀 | 简单 | 面试经典 150 |
| 4 | 468 | 验证 IP 地址 | 中等 | 字节面经高频 |
| 5 | 118 | 杨辉三角 | 简单 | Hot 100 |
| 6 | 112 | 路径总和 | 简单 | 树 DFS 基础 |
| 7 | 129 | 求根节点到叶节点数字之和 | 中等 | 树 DFS 变形 |
| 8 | 222 | 完全二叉树的节点个数 | 简单 | 完全二叉树性质 + 二分 |
| 9 | 509 | 斐波那契数 | 简单 | 剑指 Offer 10，DP 入门 |
| 10 | 191 | 位 1 的个数 | 简单 | 剑指 Offer 15，位运算入门 |
| 11 | 371 | 两整数之和 | 中等 | 剑指 Offer 65，位运算模拟加法 |
