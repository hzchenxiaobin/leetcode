...
| 优先级 | 题号 | 题目 | 难度 | 高频理由 |
|--------|------|------|------|----------|
| 1 | 74 | 搜索二维矩阵 | 中等 | Hot 100 |
| 2 | 35 | 搜索插入位置 | 简单 | Hot 100 |
| 3 | 93 | 复原 IP 地址 | 中等 | 回溯经典，分段剪枝 |
| 4 | 8 | 字符串转换整数（atoi） | 中等 | 边界处理考察，高频 |
| 5 | 14 | 最长公共前缀 | 简单 | 面试经典 150 |
| 6 | 468 | 验证 IP 地址 | 中等 | 字节面经高频 |
| 7 | 118 | 杨辉三角 | 简单 | Hot 100 |
| 8 | 112 | 路径总和 | 简单 | 树 DFS 基础 |
| 9 | 129 | 求根节点到叶节点数字之和 | 中等 | 树 DFS 变形 |
| 10 | 222 | 完全二叉树的节点个数 | 简单 | 完全二叉树性质 + 二分 |
| 11 | 509 | 斐波那契数 | 简单 | 剑指 Offer 10，DP 入门 |
| 12 | 191 | 位 1 的个数 | 简单 | 剑指 Offer 15，位运算入门 |
| 13 | 371 | 两整数之和 | 中等 | 剑指 Offer 65，位运算模拟加法 |

> 💡 另有 2 道无主站对应题的剑指 Offer 高频题：**数组中的逆序对**（LCR 170 / 剑指 Offer 51，归并分治 / 树状数组）、**圆圈中最后剩下的数字**（LCR 187 / 剑指 Offer 62，约瑟夫环递推）。它们不在主站题号体系内，无法按区间目录归档，可选补写、不计入本清单。
