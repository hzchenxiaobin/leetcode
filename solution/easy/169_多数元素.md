...
- [34. 在排序数组中查找元素的第一个和最后一个位置](https://leetcode.cn/problems/find-first-and-last-position-of-element-in-sorted-array/)（[题解](../medium/34_在排序数组中查找元素的第一个和最后一个位置.md)）：配合二分可在有序数组中 `O(log n)` 统计某元素次数
